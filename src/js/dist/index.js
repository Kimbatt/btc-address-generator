...
window.addEventListener("load", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function ShowRandomnessCanvas() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        randomnessCanvas = document.getElementById("randomness_canvas");
                        randomnessCanvasCTX = randomnessCanvas.getContext("2d");
                        randomnessText = document.getElementById("randomness_div");
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                document.getElementById("randomness_skip_button").addEventListener("click", function () { return resolve(null); });
                            })];
                    case 1:
                        entropy = _a.sent();
                        if (entropy !== null) {
    ...
    var _a, isDarkMode, Get32SecureRandomBytes, SetEntropy;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = Util(), isDarkMode = _a.isDarkMode, Get32SecureRandomBytes = _a.Get32SecureRandomBytes, SetEntropy = _a.SetEntropy;
                InitFavicon();
