...
function InitTests()
{
    ...
    interface Bip38Test
    {
        ...
        encryptedPrivateKeyFromPrivkey: string;
    ...
    async function RunAllTests(): Promise<string[]>
    {
        ...
        async function TestAddressesAndPrivkeys()
        {
        ...
        async function TestBip38()
        {
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYTvmU4NwNMgdT4ibYvRkAnZe3tWAMUXhvR9AxDziriJ6fWusqRo1BfaN",
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYLpyAsCpquTahxC96c5BJtW7ZQjMLJCyd2Fw4BpQutjArJTzkrXB7Piv",
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYVX9pgijT18gua44qWPypmzsoHCe8pPXCNQZpghSGg7oS6PUPMQ7G1uJ",
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYWm6R3tdgAaJKna9veriFkCcMeoLLWVTnpcznxot1Xqwi4TtWHhnXXxk",
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYT28TWz92xdoTBoFeo7jF4xyi69wENqHmSgjJyAxxC3gMHathn17MLfh",
            ...
            testCases.push({
                ...
                encryptedPrivateKeyFromPrivkey: "6PYT5Pay1zNPJKLheQTknQAdTX7PZC4aaUGwm85D3m4GXVLyoL6asAaymA",
            ...
            await Promise.all(testCases.map(testCase => (async () =>
            {
                async function TestDecrypt(privateKey: string, password: string)
                {
                    try
                    {
                        ...
                        {
                            Assert(false, `Bip38 decrypt error for privkey "${privateKey}" with password "${password}"`);
                        }
                        else
                        {
                ...
                await TestDecrypt(testCase.encryptedPrivateKeyFromPrivkey, testCase.password);
                ...
                async function TestEncrypt(privateKey: string, password: string)
                {
                    try
                    {
                        ...
                        {
                            AssertEqual(encrypted.result, testCase.encryptedPrivateKeyFromPrivkey, "Encrypted private key does not match");
                        }
                    }
                    catch (e)
                    {
            ...
            await Promise.all(testCases.map(testCase => (async () =>
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        AssertEqual(deriveResult.result.privateKey, testCase.extendedPrivkey, "Extended private keys don't match");
